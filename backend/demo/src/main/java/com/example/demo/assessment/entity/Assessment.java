...
public class Assessment extends BaseTimestampEntity {
    ...
    public Assessment(String title, String description, String tag, Integer sortOrder) {
        this.title = title;
    ...
    public void addQuestion(AssessmentQuestion question) {
        ...
        question.assignToAssessment(this);
    }
