...
public class PdfDocumentService {
    ...
    public List<ExtractedPdfPage> extractPages(InputStream inputStream, int pageStart, int pageEnd) {
        try (PDDocument document = PDDocument.load(inputStream)) {
    ...
    public String extractText(InputStream inputStream, int pageStart, int pageEnd) {
    ...
    public record ExtractedPdfPage(Integer pageNumber, String text) {
    }
}
