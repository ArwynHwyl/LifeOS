  ...
  <Transition name="assistant-panel">
    <aside v-if="open" class="assistant-panel" aria-label="AI learning assistant">
      <header class="assistant-header">
        <div class="assistant-avatar"><ToraMascot crop="head" :size="36" :track="false" aria-hidden="true" /></div>
...
/* Tora is an inline SVG (not an <img>), so center it inside the round avatar */
.assistant-avatar{display:grid;place-items:center;flex-shrink:0}
.assistant-quick-actions__toggle{display:flex;width:100%;align-items:center;justify-content:space-between;border:0;background:transparent;padding:.1rem .15rem;color:#5f5951;font-size:.65rem;font-weight:900;cursor:pointer}
.assistant-quick-actions .assistant-suggestions{gap:.35rem;margin:.4rem 0 .1rem}
.assistant-state{display:grid;justify-items:center;gap:.7rem}.assistant-state--error{color:#8c3322}.assistant-state button,.assistant-review-state button{border:1.5px solid #1d1b17;border-radius:999px;background:#fff;padding:.3rem .65rem;color:#1d1b17;font-size:.68rem;font-weight:850;cursor:pointer}.assistant-context{display:flex;align-items:center;flex-wrap:wrap;gap:.25rem;margin-bottom:.55rem;color:#6b6660;font-size:.6rem}.assistant-context strong{color:#1d1b17}.assistant-context b{font-weight:500}.assistant-review-list>div:not(.assistant-review-state){display:grid;border-left:3px solid #3a7d44;background:#fff;padding:.35rem .5rem}.assistant-review-state{display:grid;justify-items:start;gap:.4rem;border-left:3px solid #9b948a;background:#fff;padding:.5rem;color:#6b6660;font-size:.65rem}.assistant-review-state--error{border-left-color:#c44a1a;color:#8c3322}
</style>
